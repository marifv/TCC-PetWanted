...
export default function AnimalEncontrado({ onVoltar, setTelaAtual, abrirAnimalPerdido, abrirChat, abrirAdocao }) {
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.cabecalho}>
                ...
                <Text style={styles.titulo}>Animal Encontrado</Text>
